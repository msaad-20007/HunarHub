...
public class MessageHandler implements HttpHandler {
    ...
    private void handleGet(HttpExchange ex) throws IOException {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            String sql = "SELECT m.message_id, m.sender_id, m.receiver_id, m.content, m.sent_at, " +
            ...
            while (rs.next()) {
                ...
                o.put("text",        rs.getString("content"));
                o.put("timestamp",   rs.getString("sent_at"));
        ...
        try (InputStream is = ex.getRequestBody()) {
            ...
            try (Connection conn = DatabaseConnection.getConnection()) {
                ...
                PreparedStatement fetch = conn.prepareStatement(
                    "SELECT m.message_id, m.sender_id, m.receiver_id, m.content, m.sent_at, u.name as sender_name " +
                ...
                if (rs.next()) {
                    ...
                    saved.put("text",       rs.getString("content"));
                    saved.put("timestamp",  rs.getString("sent_at"));
