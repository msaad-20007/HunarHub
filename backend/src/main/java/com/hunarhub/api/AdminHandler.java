        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try (Connection conn = DatabaseConnection.getConnection()) {
                String sql = "SELECT u.id, u.name, u.email, u.phone, u.address_city AS city, u.dob, " +
                             "w.worker_id, w.cnic, w.whatsapp, c.category_name AS category, w.approval_status, w.rating " +
                    ...
                    if (rows > 0) {
                        ...
                        try {
                            PreparedStatement ep = conn.prepareStatement(
                                "SELECT u.email, u.name, c.category_name AS category FROM users u " +
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try (Connection conn = DatabaseConnection.getConnection()) {
                ...
                String sql = "SELECT b.booking_id, b.type, b.booking_date, b.status, " +
                             ...
                             "COALESCE(wu.address_city, '') as worker_city, " +
