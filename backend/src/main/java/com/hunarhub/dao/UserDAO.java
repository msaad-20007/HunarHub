...
public class UserDAO {
    ...
    public int createUser(User user) {
        String sql = "INSERT INTO users (name, email, password, phone, dob, address_city, address_street, address_zip, role) " +
                     "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            pstmt.setString(7, user.getAddressStreet());
            pstmt.setString(8, user.getAddressZip());
