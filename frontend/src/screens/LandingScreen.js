...
const FEATURES = [
  { icon: '⚡', title: 'Instant Booking',  desc: 'Book a skilled worker in seconds',       color: '#FFD700' },
  { icon: '✅', title: 'Verified Workers', desc: 'Approved & rated professionals only',     color: '#00E676' },
  { icon: '💬', title: 'Direct Chat',      desc: 'Talk to workers before you hire',         color: '#00D2FF' },
  { icon: '📍', title: 'Near You',         desc: 'Find workers in your city instantly',     color: '#FF6B6B' },
];
