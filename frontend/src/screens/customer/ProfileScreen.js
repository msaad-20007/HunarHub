...
const InfoRow = ({ iconName, label, value }) => (
  <View style={s.infoRow}>
    <View style={s.infoIconBox}>
      <Ionicons name={iconName} size={20} color="#3A7BD5" />
    </View>
          ...
          <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideY }] }}>
            ...
            <LinearGradient colors={['#0A1E32', '#0C2540']} style={s.hero}>
              ...
              <View style={s.roleBadge}>
                <Ionicons name={roleIcon} size={14} color="#00D2FF" style={{ marginRight: 6 }} />
              ...
              <View style={s.accountCard}>
                <TouchableOpacity style={s.accountRow} activeOpacity={0.7}>
                  <View style={s.accountIconBox}>
                    <Ionicons name="lock-closed-outline" size={18} color="#3A7BD5" />
                  </View>
...
const s = StyleSheet.create({
  ...
  avatar: {
    ...
    shadowColor: '#3A7BD5', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.5, shadowRadius: 15, elevation: 12,
  },
  avatarTxt: { fontSize: 34, fontWeight: '900', color: '#FFF' },
  name: { fontSize: 24, fontWeight: '800', color: '#D8EAF8', marginBottom: 10 },
  roleBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#00D2FF15', borderRadius: 20, borderWidth: 1, borderColor: '#00D2FF30', paddingHorizontal: 14, paddingVertical: 6, marginBottom: 8 },
  ...
  accountIconBox: { width: 36, height: 36, borderRadius: 10, backgroundColor: '#3A7BD512', borderWidth: 1, borderColor: '#3A7BD525', justifyContent: 'center', alignItems: 'center', marginRight: 14 },
