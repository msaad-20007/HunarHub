    ...
    >
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <LinearGradient colors={['#7C3AED25', '#A855F720']} style={styles.headerAv}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyWrap}>
              <Ionicons name="chatbubbles-outline" size={48} color="#6B6880" style={{ marginBottom: 12 }} />
...
const styles = StyleSheet.create({
  ...
  headerAv:     { width: 36, height: 36, borderRadius: 18, justifyContent: 'center', alignItems: 'center', marginRight: 8, borderWidth: 1, borderColor: '#7C3AED30' },
  headerAvTxt:  { fontSize: 15, fontWeight: '800', color: '#7C3AED' },
