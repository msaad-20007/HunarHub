...
const ForgotPasswordScreen = ({ navigation }) => {
  ...
  const STEP_META = [
    ...
    { icon: 'keypad-outline',      color: '#7C3AED', title: 'Enter Code',        subtitle: `We sent a 6-digit code to\n${email}` },
  ...
  const renderStep = () => {
    if (step === 1) return (
      <View style={s.card}>
        ...
        <View style={s.inputWrap}>
          <Ionicons name="mail-outline" size={18} color="#6B6880" style={s.inputIcon} />
          <TextInput
            style={s.input} placeholder="Enter your email" placeholderTextColor="#6B6880"
    ...
    if (step === 2) return (
      <View style={s.card}>
        ...
        <TouchableOpacity style={s.changeRow} onPress={() => { setOtp(''); goStep(1); }}>
          <Ionicons name="chevron-back" size={14} color="#6B6880" />
    ...
    if (step === 3) return (
      <View style={s.card}>
        ...
        <View style={s.inputWrap}>
          <Ionicons name="lock-closed-outline" size={18} color="#6B6880" style={s.inputIcon} />
          <TextInput
            style={s.input} placeholder="Min. 6 characters" placeholderTextColor="#6B6880"
...
const s = StyleSheet.create({
  ...
  stepDot: {
    ...
    backgroundColor: '#13111C', borderWidth: 1.5, borderColor: '#2D2640',
    justifyContent: 'center', alignItems: 'center',
  },
  stepDotActive: { backgroundColor: '#7C3AED18', borderColor: '#7C3AED' },
  stepNum: { fontSize: 13, color: '#6B6880', fontWeight: '700' },
  stepNumActive: { color: '#7C3AED' },
  stepLine: { width: 40, height: 1.5, backgroundColor: '#2D2640', marginHorizontal: 4 },
  stepLineActive: { backgroundColor: '#7C3AED60' },
  iconWrap: { marginBottom: 20 },
  iconBg: { width: 80, height: 80, borderRadius: 24, justifyContent: 'center', alignItems: 'center', borderWidth: 1 },
  title: { fontSize: 28, fontWeight: '900', color: '#F1F0F5', letterSpacing: 0.3, marginBottom: 8, textAlign: 'center' },
  subtitle: { fontSize: 14, color: '#6B6880', textAlign: 'center', lineHeight: 22, marginBottom: SIZES.extraLarge },
  card: {
    width: '100%', backgroundColor: 'rgba(11,24,37,0.95)',
    padding: SIZES.padding, borderRadius: 20,
    borderWidth: 1, borderColor: '#2D2640', marginBottom: SIZES.extraLarge,
  },
  label: { fontSize: 11, color: '#6B6880', fontWeight: '800', letterSpacing: 1.5, marginBottom: 8 },
  inputWrap: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: '#0A0A0F', borderRadius: 14,
    borderWidth: 1, borderColor: '#2D2640', paddingHorizontal: 14, marginBottom: 4,
  },
  ...
  otpBox: {
    ...
    backgroundColor: '#0A0A0F', borderWidth: 1.5, borderColor: '#2D2640',
    textAlign: 'center', fontSize: 22, fontWeight: '800', color: '#F1F0F5',
  },
  otpBoxFilled: { borderColor: '#7C3AED', backgroundColor: '#7C3AED10' },
  resendRow: { alignItems: 'center', marginTop: 16 },
  resendTimer: { fontSize: 13, color: '#6B6880' },
  resendLink: { fontSize: 13, color: '#6B6880' },
  resendLinkBold: { color: '#7C3AED', fontWeight: '700' },
  changeRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 10 },
  changeText: { fontSize: 13, color: '#6B6880' },
  strengthRow: { flexDirection: 'row', alignItems: 'center', marginTop: 10, gap: 4 },
  strengthBar: { flex: 1, height: 4, borderRadius: 2, backgroundColor: '#2D2640' },
  strengthLabel: { fontSize: 11, color: '#6B6880', marginLeft: 6, fontWeight: '700', width: 40 },
  loginRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 8 },
  loginText: { fontSize: 14, color: '#6B6880' },
